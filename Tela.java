...
public class Tela extends javax.swing.JFrame {
    ...
    public Tela(String num1, String num2, String res, String sinal, JLabel lblRes) {
        this.num1 = num1;
        this.num2 = num2;
        this.res = res;
        this.sinal = sinal;
    ...
    public JLabel getLblRes() {
     ...
     public void tiraSinal(){
         String texto = lblRes.getText();
         if (texto.equals("+")||
            (texto.equals("-")||
            (texto.equals("*")||
            (texto.equals("/")||
     ...
     public  void calculo() {
         ...
         if (sinal.equals("+")){
            total = Float.parseFloat(num1)+Float.parseFloat(num2); 
         }
         if (sinal.equals("-")){
            total = Float.parseFloat(num1)-Float.parseFloat(num2);
         }
    ...
    private void initComponents() {
        ...
        lblRes.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(255, 255, 255)));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"4");
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        setCor(); 
        tiraSinal();
        lblRes.setText(lblRes.getText()+"5");
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"6");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"7");
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"8");
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"9");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"0");
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        setCor();
        
        lblRes.setText(lblRes.getText()+".");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"2");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"1");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        setCor();
        tiraSinal();
        lblRes.setText(lblRes.getText()+"3");
